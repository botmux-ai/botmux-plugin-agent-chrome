...
.ac-error{margin:14px 0 0;border-left:3px solid var(--danger,#d92d20);background:color-mix(in srgb,var(--danger,#d92d20) 10%,var(--ac-panel));color:var(--ac-ink);padding:10px 12px;font-size:13px}.ac-layout{display:grid;grid-template-columns:minmax(220px,270px) minmax(0,1fr);min-height:580px}
.ac-sidebar{border-right:1px solid var(--ac-border);padding:18px 18px 18px 0;min-width:0}.ac-sidebar-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:12px}.ac-sidebar-head h2{font-size:14px;line-height:20px;margin:0;font-weight:700}.ac-count{display:inline-flex;min-width:24px;height:22px;align-items:center;justify-content:center;border-radius:11px;background:var(--ac-soft);color:var(--ac-muted);font-size:12px;font-weight:700}
